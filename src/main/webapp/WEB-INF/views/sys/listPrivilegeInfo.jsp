...
<HEAD>
    ...
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/common/ztree/js/jquery.ztree.core-3.5.js"></script>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/common/ztree/js/jquery.ztree.excheck-3.5.js"></script>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/common/ztree/js/jquery.ztree.exedit-3.5.js"></script>
    <SCRIPT type="text/javascript">
...
<TABLE border=0 height=600px align=left>
    <TR>
        ...
        <TD width=80% align=left valign=top>
            <IFRAME ID="Iframe" Name="Iframe" FRAMEBORDER=0 SCROLLING=AUTO style="width: 100%;height: 100%"
                    SRC=""></IFRAME>
        </TD>
    </TR>
</TABLE>
