...
<html>
  ...
  <body>
	...
	<div id="dd"  style="height:auto;width: auto;" data-options="title:'',maximizable:true,modal: true,draggable:false" class="easyui-dialog" closed=true> 
	 <form id="privilegeInfoform">
		<div id="tt" class="easyui-tabs" data-options="tools:'#tab-tools', border:false" style="height:200px;width:500px">
			<div title="新增权限" style="padding:5px">
			    <table class="table-edit" align="center">
				  <tr>
						<td width="200">权限菜单名称:</td>
						<td>
							<input type="text" name="privilegename" class="easyui-validatebox" value="" data-options="required:true" />						
						</td>
					</tr>
					<tr>
						<td>权限URL:</td>
						<td><input type="text" name="page" class="easyui-validatebox" value=""data-options="required:true" /></td>
					</tr>
					<tr>
						<td>权限代码:</td>
						<td><input type="text" name="privilegecode" class="easyui-validatebox" value=""data-options="required:true" /></td>
					</tr>
	...
	<div id="tab-tools">
		<a type="submit" id="saveprivilege" class="easyui-linkbutton" title="保存"   data-options="plain:true,iconCls:'icon-save'" ></a>
