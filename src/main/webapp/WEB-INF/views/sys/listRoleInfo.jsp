...
<html>
  ...
  <body>
		...
		<div id="tt" class="easyui-tabs" data-options="tools:'#tab-tools', border:false" style="height:390px;">
			<div title="新增角色" style="padding:5px">
			    <table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>角色代码:</td>
						<td><input type="text" name="rolecode" class="easyui-validatebox" data-options="required:true" /></td>
					</tr>
					<tr>
						<td>角色描述:</td>
	...
	<div id="tab-tools">
		<a type="submit" id="saverole" class="easyui-linkbutton" title="保存"   data-options="plain:true,iconCls:'icon-save'" ></a>
