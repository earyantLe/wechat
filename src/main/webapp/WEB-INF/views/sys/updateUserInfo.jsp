			    ...
			    <table class="table-edit" width="80%" align="center">
			       <input type="hidden" name="id"  value="${user.id}"/>
					<tr>
						<td width="200">姓名:</td>
						<td>
							<input type="text" name="username" class="easyui-validatebox" value="${user.username}" data-options="required:true" />						
						</td>
					</tr>
					<tr>
						<td>登录名称:</td>
						<td><input type="text" name="loginname" class="easyui-validatebox" value="${user.loginname }"data-options="required:true" /></td>
					</tr>
					<tr>
						<td>登录密码:</td>
						<td>
						    <input type="password" name="loginpwd" class="easyui-validatebox" value="${user.loginpwd }" data-options="required:true" />
