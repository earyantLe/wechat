        ...
        <div title="修改用户" style="padding:5px">
            <table class="table-edit" width="80%" align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="privilegename" class="easyui-validatebox" value="${pri.privilegename}"
                               data-options="required:true"/>
                    </td>
                </tr>
                <tr>
                    <td>权限URL:</td>
                    <td><input type="text" name="page" class="easyui-validatebox" value="${pri.page }"
                               data-options="required:true"/></td>
                </tr>
                <tr>
                    <td>权限代码:</td>
                    <td><input type="text" name="privilegecode" class="easyui-validatebox" value="${pri.privilegecode}"
                               data-options="required:true"/></td>
                </tr>
