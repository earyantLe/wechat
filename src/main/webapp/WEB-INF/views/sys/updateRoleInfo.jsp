			    ...
			    <table class="table-edit" width="80%" align="center">
					<tr>
						...
						<td>
							...
							<input type="text" name="rolename" value="${role.rolename}" class="easyui-validatebox" data-options="required:true" />						
						</td>
					</tr>
					<tr>
						<td>角色代码:</td>
						<td><input type="text" name="rolecode" value="${role.rolecode}" class="easyui-validatebox" data-options="required:true" /></td>
					</tr>
					<tr>
						<td>角色描述:</td>
