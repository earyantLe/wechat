...
(function ($) {
    ...
    function _7(_8) {
        ...
        if (_a.buttonText || _a.buttonIcon) {
            ...
            _b.addClass("textbox-button-" + _a.buttonAlign).linkbutton({
                text: _a.buttonText, iconCls: _a.buttonIcon, onClick: function () {
    ...
    $.fn.textbox.parseOptions = function (_4d) {
        var t = $(_4d);
        return $.extend({}, $.fn.validatebox.parseOptions(_4d), $.parser.parseOptions(_4d, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", {
            multiline: "boolean",
            editable: "boolean",
            iconWidth: "number"
        }]), {
