...
(function ($) {
            ...
            if (col && col.editor) {
                ...
                if (_153) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _153,
                        target: _153.init(cell.find("td"), _152),
                        field: _150,
                        type: _151,
                        oldHtml: _154
                    });
    ...
    var _19e = $.extend({}, _190(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
    ...
    $.fn.datagrid.parseOptions = function (_1e4) {
        var t = $(_1e4);
        return $.extend({}, $.fn.panel.parseOptions(_1e4), $.parser.parseOptions(_1e4, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        loader: function (_224, _225, _226) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _224, dataType: "json", success: function (data) {
                    _225(data);
                }, error: function () {
