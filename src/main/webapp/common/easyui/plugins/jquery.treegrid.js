...
(function ($) {
    ...
    $.fn.treegrid = function (_b1, _b2) {
        ...
        return this.each(function () {
            ...
            if (_b4) {
                ...
                _b4 = $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _b1),
                    data: []
                });
            }
            _1(this);
    ...
    var _c5 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_c6, _c7, _c8) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        loader: function (_10c, _10d, _10e) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _10c, dataType: "json", success: function (data) {
                    _10d(data);
                }, error: function () {
        ...
        finder: {
            getTr: function (_110, id, type, _111) {
                type = type || "body";
                _111 = _111 || 0;
