...
(function ($) {
    function _1(_2) {
        ...
        if (!_3.panel) {
            ...
            _3.panel.panel({
                minWidth: _4.panelMinWidth,
                maxWidth: _4.panelMaxWidth,
                minHeight: _4.panelMinHeight,
                maxHeight: _4.panelMaxHeight,
                doSize: false,
                closed: true,
                cls: "combo-p",
        ...
        $(_2).addClass("combo-f").textbox($.extend({}, _4, {
            icons: _6, onChange: function () {
            }
        }));
    ...
    function _1b(_1c) {
        ...
        if (_1f.panel("options").closed) {
            _1f.panel("open").panel("resize", {
                width: (_20.panelWidth ? _20.panelWidth : _1e._outerWidth()),
                height: _20.panelHeight
            });
    ...
    $.fn.combo = function (_48, _49) {
        ...
        return this.each(function () {
            ...
            if (_4b) {
                ...
                _4b = $.data(this, "combo", {
                    options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _48),
                    previousText: ""
                });
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _12, keydown: _17, paste: _17, drop: _17},
        panelWidth: null,
        panelHeight: 200,
        panelMinWidth: null,
        panelMaxWidth: null,
