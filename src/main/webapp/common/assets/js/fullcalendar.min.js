...
(function(t, e) {
    ...
    function r(n, r, c) {
        ...
        r.droppable && t(document).bind("dragstart",//向上拖动开始
        function(e, n) {
            var a = e.target,
            o = t(a);
    ...
    var Ce = {
        defaultView: "agendaWeek",//设置已周样式显示
        aspectRatio: 1.35,
        header: {
            left: "title",
            center: "",
        ...
        isRTL: !1,
        firstDay: new Date().getDay(),//设置起始日期  当前日期周几
