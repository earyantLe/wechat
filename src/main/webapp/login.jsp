...
<body>
	...
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<form id="loginform" name="loginform" method="post"  action="<%=request.getContextPath()%>/oper/user/validationUser.do">
					...
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						...
						<input type="text" id="loginformidInput" name="loginname" class="easyui-validatebox"  maxlength="50" />		
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<div id="codeInputLine" class="loginFormIpt showPlaceholder"
							...
							<img id="loginformvCode" style="cursor: pointer;" src="<%=request.getContextPath()%>/validatecode.jsp"
