package com.ctsig.sys.wechat.service.impl;


import com.ctsig.sys.gank.dao.AllContentBeanMapper;
import com.ctsig.sys.gank.dao.DayMapper;
import com.ctsig.sys.gank.dao.GankContentMapper;
import com.ctsig.sys.gank.domain.AllContentBeanWithBLOBs;
import com.ctsig.sys.gank.domain.GankContent;
import com.ctsig.sys.wechat.service.GankService;
...
//                String d = day[i];
                for (int i = 0; i < day.size(); i++) {
                    ...
                    com.ctsig.sys.gank.domain.Day da = new com.ctsig.sys.gank.domain.Day();
                    da.setDayDate(date);
//                    com.ctsig.sys.gank.domain.Day dayIsExist = dayMapper.selectBydate(date);
                    //所有的Day日期保存到数据库中
